...
void test_validate_my_username()
{
  ...
  const char *name_config = malloc_username_from_conf_file();
   
TEST_ASSERT_EQUAL_STRING_MESSAGE(username, name_config,
                                   "Username mismatch between my_username() and username.txt!");
